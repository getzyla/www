                ...
                <div class="mt-12 border rounded-md bg-gradient-to-br from-primary/5 to-secondary/5 p-8">
                    <div class="text-center">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                            ...
                            <a href="https://github.com/getzyla/www" class="inline-flex items-center gap-2 px-6 py-3 rounded-md border bg-background hover:bg-secondary/50 transition-colors font-medium text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
